/* Adapted from https://github.com/fxnn/readable-hash
 * 
 * See LICENSES/LICENSE.readable-hash for license details.
 */

package au.com.dius.pact.soap.hash;
...
public class ReadableHash {
	...
	public String toReadableString(@Nullable Long value, int minSyllableCountPerWord, int maxSyllableCountPerWord) {
		if (value != null) {
			...
			int syllableCount = rng.nextInt(maxSyllableCountPerWord - minSyllableCountPerWord + 1)
					+ minSyllableCountPerWord;
