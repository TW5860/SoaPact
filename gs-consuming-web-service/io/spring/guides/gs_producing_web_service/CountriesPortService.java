 ...
 * 2017-09-26T10:08:19.304+02:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "CountriesPortService", 
                  wsdlLocation = "http://localhost:8080/ws/countries.wsdl",
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CountriesPortService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/ws/countries.wsdl");
        }
        WSDL_LOCATION = url;
    }
